...
export function measure(pzFont: any, o: any) {
    if (!o) o = {}

    if (typeof pzFont === 'string' || Array.isArray(pzFont)) {
        o.family = pzFont
    }
...
function applyOrigin(obj: any, origin: number) {
    var res = {}
...
function firstBottom(iData: any) {
    var l = iData.height
    var data = iData.data
